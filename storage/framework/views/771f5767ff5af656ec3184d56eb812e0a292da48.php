...
<body class="d-flex flex-column min-vh-100">
    ...
    <div class="container my-5">
        ...
        <?php endif; ?>
        <form enctype="multipart/form-data" action="/executeedit/<?php echo e($movie->id); ?>" method="POST" class="row w-100">
            <?php echo csrf_field(); ?>
            <div class="my-1">
                <label for="title" class="mb-1">Title</label>
                <input type="text" class="form-control input-text w-100 text-white" name="title" id="title" value="<?php echo e($movie->title); ?>">
            </div>
            <div class="my-1">
                <label for="description" class="mb-1">Description</label>
                <textarea name="description" class="form-control bg-1 text-white border-0" id="" cols="30" rows="10" style="transition: none" value="<?php echo e($movie->description); ?>"></textarea>
            </div>
            <div class="my-1">
            ...
            <div class="my-1">
                ...
                <input type="text" class="form-control input-text w-100 text-white" name="director" id="director" value="<?php echo e($movie->director); ?>">
            </div>
            <div class="my-1">
                <label for="release_date" class="mb-1">Release Date</label>
                <input type="date" class="form-control bg-1 text-white border-0" name="release_date" id="release_date" value="<?php echo e($movie->release_date); ?>">
            </div>
            <div class="my-1">
...
</html><?php /**PATH D:\BINUS\SEMESTER 5\LAB - Web Programming\PROJECT\source\source\resources\views/edit_movie.blade.php ENDPATH**/ ?>