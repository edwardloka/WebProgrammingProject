    ...
    <div class="container my-5">
        ...
        <form  enctype="multipart/form-data" action="/executeedit" method="POST" class="row w-100">
            ...
            <div class="my-1">
                ...
                <input type="text" class="form-control input-text w-100 text-white" name="name" id="name" value="<?php echo e($actor->name); ?>">
            </div>
            <div class="my-1">
                ...
                <select name="gender" id="gender" class="form-select bg-1 text-white border-0">
                    ...
                    <option value="male" <?php echo e(strcasecmp($actor->gender, "male") == 0 ? 'selected' : ''); ?>>Male</option>
                    <option value="female"<?php echo e(strcasecmp($actor->gender, "female") == 0 ? 'selected' : ''); ?>>Female</option>
                </select>
            </div>
            <div class="my-1">
            ...
            <div class="my-1">
                ...
                <input type="date" class="form-control bg-1 text-white border-0" name="dob" id="dob" value="<?php echo e($actor->dob); ?>">
            </div>
            <div class="my-1">
                <label for="pob" class="mb-1">Place of Birth</label>
                <input type="text" class="form-control input-text w-100 text-white" name="pob" id="pob" value="<?php echo e($actor->pob); ?>">
            </div>
            <div class="my-1">
...
</html><?php /**PATH D:\BINUS\SEMESTER 5\LAB - Web Programming\PROJECT\source\source\resources\views/edit_actor.blade.php ENDPATH**/ ?>